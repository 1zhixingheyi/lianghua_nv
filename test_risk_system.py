...
# 导入风控模块
from risk.risk_config import RiskConfig, RiskLevel, RiskEventType
from risk.base_risk import BaseRiskManager, RiskCheckStatus
from risk.position_manager import PositionManager, PositionType
from risk.money_manager import MoneyManager, FundType
from risk.risk_monitor import RiskMonitor
from risk.risk_engine import RiskEngine, StrategyRiskAdapter, BacktestRiskAdapter
...
class TestRiskConfig(unittest.TestCase):
    ...
    def test_risk_event_management(self):
        """测试风控事件管理"""
        from risk.risk_config import RiskEvent
...
class TestRiskMonitor(unittest.TestCase):
    ...
    def test_alert_creation(self):
        """测试告警创建"""
        from risk.risk_monitor import AlertType
